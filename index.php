            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                          <a href="single-product/Cookie.php"><img src="img/product1.png" alt="" class="product-thumb"></a>
                          <h2><a href="single-product/Cookie.php">Bánh cookie</h2>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="shop.php" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product/sukem.php"><img src="img/sukem.png" alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="shop.php" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product/sukem.php"><img src="img/product4.png" alt="" class="product-thumb"></a>
                            <h2><a href="single-product.php">Bánh ngọt nhỏ ngon</a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
